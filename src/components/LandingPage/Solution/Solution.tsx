    ...
    return (
        <div id="solution">
            <div id="solution-content">
                ...
                <div className="section-description dark-text align-text-center">Imagine if you could...</div>
                <div id="solution-container">
                    <div id="solution-left">
                        <div className="step">
                            <div className="step-number">1</div>
                            <div>
                                <div className="feature-card-title dark-text">Upload Your Design</div>
                        ...
                        <div className="step">
                            ...
                            <div>
                                <div className="feature-card-title dark-text">Choose Your Model</div>
                        ...
                        <div className="step">
                            ...
                            <div>
                                <div className="feature-card-title dark-text">Customize Everything</div>
                        ...
                        <div className="step">
                            ...
                            <div>
                                <div className="feature-card-title dark-text">Export & Share</div>
