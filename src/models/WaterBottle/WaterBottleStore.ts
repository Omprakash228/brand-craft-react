...
export const useCapMaterial = create<Material & MaterialActions>((set) => ({
  ...createCapMaterial(),
  ...
  resetMaterial: () => set(createCapMaterial())
}))
...
export const useBodyMaterial = create<Material & MaterialActions>((set) => ({
  ...createBodyMaterial(),
  setColor: (color: string) => set(() => ({ color: color })),
  setRoughness: (roughness: number) =>
    set(() => ({ roughness: roughness })),
  ...
  setTransmission: (transmission: number) =>
    set(() => ({ transmission: transmission })),
  resetMaterial: () => set(createBodyMaterial())
}))
...
export const useBodyTexture = create<Texture & TextureActions>((set) => ({
  ...createTextureState(),
  texture: null,
