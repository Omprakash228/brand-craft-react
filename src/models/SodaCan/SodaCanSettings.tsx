...
import { useCanMaterial, useCanTexture, useCanTransform, useSelection } from "./SodaCanStore";
...
export default function SodaCanSettings() {
  ...
  useEffect(() => {
    canSelection.setSelected("Can");

    return () => {
      canSelection.resetSelected();
    };
  }, []);
  ...
  return (
    <>
      <Accordion.Root
        collapsible
        defaultValue={["Transform", "Material", "Image"]}
        multiple={true}
      >
