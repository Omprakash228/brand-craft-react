...
export default function ShirtSettings() {
  ...
  useEffect(() => {
    shirtSelection.setSelected("Front");

    return () => {
      shirtSelection.resetSelected();
    };
  }, []);
  ...
  return (
    <>
      ...
      >
          ...
          <Accordion.ItemContent>
            <Accordion.ItemBody>
              ...
              <CheckBox
                ...
                onChange={(value) => {
                  shirtTransform.setGlobalMaterial(!!value);
                }}
              />
        ...
        {shirtSelection.selectedMesh === "Collar" &&
          !shirtTransform.globalMaterial && (
        ...
        {shirtSelection.selectedMesh === "Front" &&
          !shirtTransform.globalMaterial && (
          ...
          <Accordion.Item value="Front Image">
            ...
            <Accordion.ItemContent>
              <Accordion.ItemBody>
                <TextureControls
                  store={frontTexture}
                  targetWidth={frontTargetWidth}
                  targetHeight={frontTargetHeight}
                />
              </Accordion.ItemBody>
            </Accordion.ItemContent>
          </Accordion.Item>
        )}
        {shirtSelection.selectedMesh === "Back" &&
          !shirtTransform.globalMaterial && (
        ...
        {shirtSelection.selectedMesh === "RightSleeve" &&
          !shirtTransform.globalMaterial && (
            <Accordion.Item value="Right Sleeve Material">
              <Accordion.ItemTrigger>
                ...
                <Span
                  ...
                  onClick={($event) => {
                    $event.stopPropagation();
                    rightSleeveMaterial.resetMaterial();
                  }}
                >
                  <MdRefresh />
                </Span>
          ...
          <Accordion.Item value="Right Sleeve Image">
            <Accordion.ItemTrigger>
              ...
              <Span
                ...
                onClick={($event) => {
                  $event.stopPropagation();
                  rightSleeveTexture.resetTexture();
                }}
              >
                <MdRefresh />
              </Span>
            ...
            <Accordion.ItemContent>
              <Accordion.ItemBody>
                <TextureControls
                  store={rightSleeveTexture}
                  targetWidth={sleeveTargetWidth}
                  targetHeight={sleeveTargetHeight}
                />
              </Accordion.ItemBody>
            </Accordion.ItemContent>
          </Accordion.Item>
        )}
        {shirtSelection.selectedMesh === "LeftSleeve" &&
          !shirtTransform.globalMaterial && (
            <Accordion.Item value="Left Sleeve Material">
              <Accordion.ItemTrigger>
                ...
                <Span
                  ...
                  onClick={($event) => {
                    $event.stopPropagation();
                    leftSleeveMaterial.resetMaterial();
                  }}
                >
                  <MdRefresh />
                </Span>
          ...
          <Accordion.Item value="Left Sleeve Image">
            <Accordion.ItemTrigger>
              ...
              <Span
                ...
                onClick={($event) => {
                  $event.stopPropagation();
                  leftSleeveTexture.resetTexture();
                }}
              >
                <MdRefresh />
              </Span>
